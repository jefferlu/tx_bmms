...
export function getURN(object: IObject | hi.IVersion): string{
...
export function getModelDerivativeClientForObject(object: IObject | hi.IVersion, context: IContext): ModelDerivativeClient{
	if('objectId' in object){ //IObject
