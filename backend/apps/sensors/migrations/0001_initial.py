# Generated by Django 5.2 on 2025-12-12 10:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'sensors',
                'ordering': ['sensor_id'],
                'indexes': [models.Index(fields=['sensor_type', 'is_active'], name='sensors_sensor__e85a3d_idx'), models.Index(fields=['mqtt_topic'], name='sensors_mqtt_to_b093b1_idx')],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-timestamp'],
                'indexes': [models.Index(fields=['sensor', '-timestamp'], name='sensor_data_sensor__518ab2_idx'), models.Index(fields=['status', '-timestamp'], name='sensor_data_status_feb5da_idx')],
            },
        ),
    ]
