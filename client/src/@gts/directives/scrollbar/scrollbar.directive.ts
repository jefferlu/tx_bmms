...
import { ScrollbarGeometry, ScrollbarPosition } from '@gts/directives/scrollbar/scrollbar.types';
 ...
 */
@Directive({
    selector  : '[gtsScrollbar]',
    exportAs  : 'gtsScrollbar',
    standalone: true,
})
export class GtsScrollbarDirective implements OnChanges, OnInit, OnDestroy
{
    /* eslint-disable @typescript-eslint/naming-convention */
    static ngAcceptInputType_gtsScrollbar: BooleanInput;
    /* eslint-enable @typescript-eslint/naming-convention */

    @Input() gtsScrollbar: boolean = true;
    @Input() gtsScrollbarOptions: PerfectScrollbar.Options;
    ...
    {
        // Enabled
        if ( 'gtsScrollbar' in changes )
        {
            // Interpret empty string as 'true'
            this.gtsScrollbar = coerceBooleanProperty(changes.gtsScrollbar.currentValue);

            // If enabled, init the directive
            if ( this.gtsScrollbar )
            {
                this._init();
            }
        ...
        // Scrollbar options
        if ( 'gtsScrollbarOptions' in changes )
        {
            // Merge the options
            this._options = merge({}, this._options, changes.gtsScrollbarOptions.currentValue);
