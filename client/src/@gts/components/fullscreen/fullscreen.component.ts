...
import { FSDocument, FSDocumentElement } from '@gts/components/fullscreen/fullscreen.types';

@Component({
    selector       : 'gts-fullscreen',
    templateUrl    : './fullscreen.component.html',
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'gtsFullscreen',
    standalone     : true,
    imports        : [MatButtonModule, MatTooltipModule, NgTemplateOutlet, MatIconModule],
})
export class GtsFullscreenComponent implements OnInit
{
