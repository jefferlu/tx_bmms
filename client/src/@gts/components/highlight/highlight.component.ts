...
import { GtsHighlightService } from '@gts/components/highlight/highlight.service';

@Component({
    selector       : 'textarea[gts-highlight]',
    templateUrl    : './highlight.component.html',
    styleUrls      : ['./highlight.component.scss'],
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'gtsHighlight',
    standalone     : true,
    imports        : [NgClass],
})
export class GtsHighlightComponent implements OnChanges, AfterViewInit
{
    @Input() code: string;
    @Input() lang: string;
    ...
    constructor(
        ...
        private _gtsHighlightService: GtsHighlightService,
    ...
    private _highlightAndInsert(): void
    {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(SecurityContext.HTML, this._gtsHighlightService.highlight(this.code, this.lang));
