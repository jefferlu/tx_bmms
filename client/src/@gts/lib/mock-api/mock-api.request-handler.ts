...
import { GtsMockApiReplyCallback } from '@gts/lib/mock-api/mock-api.types';
import { Observable, of, take, throwError } from 'rxjs';

export class GtsMockApiHandler
{
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: GtsMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: GtsMockApiReplyCallback): void
    {
        // Store the reply
