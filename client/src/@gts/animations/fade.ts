...
import { GtsAnimationCurves, GtsAnimationDurations } from '@gts/animations/defaults';
...
const fadeIn = trigger('fadeIn',
    [
        ...
        transition('void => *', animate('{{timings}}'),
            {
                params: {
                    timings: `${GtsAnimationDurations.entering} ${GtsAnimationCurves.deceleration}`,
                },
            },
        ),
    ],
...
const fadeOut = trigger('fadeOut',
    [
        ...
        transition('* => void', animate('{{timings}}'),
            {
                params: {
                    timings: `${GtsAnimationDurations.exiting} ${GtsAnimationCurves.acceleration}`,
                },
            },
        ),
    ],
